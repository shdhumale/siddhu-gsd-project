...
<required_reading>
Read `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
