...
<required_reading>
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode
                  → checks C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done
                  → writes to C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/hooks/
...
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/references/common-bug-patterns.md
