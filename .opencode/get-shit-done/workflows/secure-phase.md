...
```
Task(
  prompt="Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/templates/SECURITY.md`
