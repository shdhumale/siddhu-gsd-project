...
<template>
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.opencode/get-shit-done/workflows/diagnose-issues.md
