...
<required_reading>
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/All_Antigravity_Project_Workspace/siddhu-gsd-project
                  → checks C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done
                  → writes to C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/hooks/
...
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/common-bug-patterns.md
