...
<required_reading>
Read `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
