...
<!-- For checkpoint task examples and patterns, see @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/checkpoints.md -->
...
See `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/workflows/verify-phase.md` for verification logic.
