...
<required_reading>
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/ai-frameworks.md
@C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-eval-planner.md for instructions.
