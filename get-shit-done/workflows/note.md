...
- **Global scope**: `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/notes/`)
...
2. Glob `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/notes/*.md` (if directory exists) — global notes
...
Global (C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/notes/` — works in any directory
