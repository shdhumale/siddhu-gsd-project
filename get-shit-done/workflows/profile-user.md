...
Key references:
- @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/ui-brand.md (display patterns)
- @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md" "C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/user-profiling.md`
...
Reference: @C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.clinerules"
...
```bash
BACKUP_PATH="C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/USER-PROFILE.backup.md"
```
...
Your profile:    C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/commands/gsd/dev-preferences.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/.clinerules
```
