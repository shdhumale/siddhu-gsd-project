...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/All_Antigravity_Project_Workspace/siddhu-gsd-project/agents/gsd-ui-checker.md for instructions.
